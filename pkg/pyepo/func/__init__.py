...
__all__ = [
    ...
    "blackboxOpt", "DBB",
    "negativeIdentity", "NID",
    "perturbedOpt", "DPO",
    "perturbedOptMul", "DPOMul",
    "perturbedFenchelYoung", "PFY",
    "perturbedFenchelYoungMul", "PFYMul",
    "implicitMLE", "IMLE",
    "adaptiveImplicitMLE", "AIMLE",
    "regularizedFrankWolfeOpt", "RFWO",
    "regularizedFrankWolfeFenchelYoung", "RFY",
    "noiseContrastiveEstimation", "NCE",
    "contrastiveMAP", "CMAP",
    "coneAlignedCosine", "CaVE",
    "listwiseLearningToRank", "lsLTR",
    "pairwiseLearningToRank", "prLTR",
    "pointwiseLearningToRank", "ptLTR",
]
